    ...
    <div className="w-full py-12 md:py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 md:mb-24">
          <h2 className="text-3xl md:text-5xl font-[900] text-primary-dark mb-6 tracking-tight">
            Thu hẹp khoảng cách <span className="text-secondary">Hướng nghiệp</span>
          </h2>
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-0">
          ...
          >
            <div className="w-24 h-24 md:w-32 md:h-32 bg-white border-4 border-slate-100 rounded-[2.5rem] flex items-center justify-center shadow-xl group-hover:border-primary-light transition-colors duration-500">
              <Database className="w-10 h-10 md:w-14 md:h-14 text-slate-400 group-hover:text-primary-light transition-colors" />
            </div>
          ...
          <div className="lg:w-1/6 flex justify-center items-center relative z-10">
            <motion.div 
              ...
              className="bg-secondary p-3 md:p-4 rounded-full shadow-2xl shadow-secondary/30"
            >
          ...
          <motion.div 
            ...
            className="relative z-10 flex flex-col items-center group w-full lg:w-1/3"
          >
            <div className="w-28 h-28 md:w-40 md:h-40 bg-primary-dark rounded-[3rem] flex items-center justify-center shadow-2xl relative overflow-hidden">
            ...
            <div className="mt-8 text-center px-6">
              <h3 className="text-xl md:text-2xl font-black text-primary-dark mb-3">Phân tích AI</h3>
            ...
            <div className="mt-6 flex gap-2">
              <span className="px-3 py-1 bg-primary-50 text-primary text-[10px] font-black rounded-full uppercase tracking-widest">Gemini 3.1</span>
              <span className="px-3 py-1 bg-primary-50 text-primary text-[10px] font-black rounded-full uppercase tracking-widest">Tối ưu</span>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="relative z-10 flex flex-col items-center group w-full lg:w-1/3"
          >
            <div className="w-24 h-24 md:w-32 md:h-32 bg-secondary rounded-[2.5rem] flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-500">
            ...
            <div className="mt-6 flex gap-2">
              <span className="px-3 py-1 bg-secondary-50 text-secondary text-[10px] font-black rounded-full uppercase tracking-widest">Độc bản</span>
              <span className="px-3 py-1 bg-secondary-50 text-secondary text-[10px] font-black rounded-full uppercase tracking-widest">Chính xác</span>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="absolute top-0 right-0 p-8 opacity-10">
            <Search className="w-32 h-32 text-primary-dark" />
          </div>
          <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-slate-200 text-xs font-black uppercase tracking-widest text-primary-dark">
                <Info className="w-4 h-4" /> Tại sao Orie Map ra đời?
              </div>
              <h4 className="text-2xl md:text-4xl font-black text-primary-dark leading-tight">
